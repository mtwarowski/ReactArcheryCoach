...
export const GET_SCOREDETAILS_BYDATE_REQUESTED = 'SCORES/GET_SCOREDETAILS_BYDATE_REQUESTED'
export const GET_SCOREDETAILS_BYDATE_LOADED = 'SCORES/GET_SCOREDETAILS_BYDATE_LOADED'
export const GET_SCOREDETAILS_BYDATE_ERROR = 'SCORES/GET_SCOREDETAILS_BYDATE_ERROR'
...
export const loadScoreByDateAsync = (date) => {
    return dispatchFirebaseAsync(() => scoresApi.GetScoreByDay(date),
        {
